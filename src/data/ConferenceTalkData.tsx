export type ConferenceTalkType = {
  id: number;
  date: string;
  name: string;
  title: string;
...
export const TALKS = [
  ...
  }, 
  {
    id: 4,
    date: 'June 14',
    name: 'President Emily Belle Freeman',
  ...
  }, 
  {
    id: 11,
    date: 'September 6',
    name: 'President Dieter F. Uchtdorf',
