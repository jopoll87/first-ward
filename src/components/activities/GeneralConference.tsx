    ...
    <Table celled basic='very' collapsing className='teaching-schedule-table' style={{margin: 'auto'}}>
      ...
      <Table.Body>
        <Table.Row>
          ...
          <Table.Cell>Elder Soares: Adorned. with the Virtue of Temperance </Table.Cell>
        ...
        <Table.Row>
          ...
          <Table.Cell>Elder Cuvelier: The Name by Which Ye Are Called</Table.Cell>
          <Table.Cell><Icon name='external alternate' /></Table.Cell>
        </Table.Row>
        <Table.Row>
          <Table.Cell>January 11</Table.Cell>
          <Table.Cell>Elder Stevenson: Blessed Are the Peacemakers</Table.Cell>
          <Table.Cell><Icon name='external alternate' /></Table.Cell>
        </Table.Row>
        <Table.Row>
        ...
        <Table.Row>
          ...
          <Table.Cell>
            ...
            <strong>and</strong> Elder Rasband: The Family Proclamation - Words
            from God
          </Table.Cell>
          <Table.Cell><Icon name='external alternate' /></Table.Cell>
        </Table.Row>
        ...
        <Table.Row>
          ...
          <Table.Cell>Elder Kearon: Jesus Christ and Your New Beginning</Table.Cell>
          <Table.Cell><Icon name='external alternate' /></Table.Cell>
        </Table.Row>
        <Table.Row>
          <Table.Cell>April 26</Table.Cell>
          <Table.Cell>Elder Uchtdorf: Do Your Part with All Your Heart</Table.Cell>
          <Table.Cell><Icon name='external alternate' /></Table.Cell>
        </Table.Row>
      </Table.Body>
    </Table>
